...
public class CardsManager extends javax.swing.JFrame {   
    ...
    ArrayList<CreditCard> listCreditCards = new ArrayList<>(); 
    ArrayList<DebitCard> listDebitCards = new ArrayList<>();
    
    public CardsManager() {
	
	// Read all the credit card info from the file if it exists 
	// First, try creating it 
	try {
	    FileWriter fw = new FileWriter("Cards.txt");
	} catch (Exception e) {}
	
	// After making sure the file exists, try to append to a list
